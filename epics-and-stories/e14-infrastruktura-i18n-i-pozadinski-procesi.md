...
- i18n framework se mora postaviti prije Listing CRUD epica (E02) jer dvojezična polja prolaze kroz sve entitete.
...
| --- | --- | --- | --- |
| S14-01 | Postavljanje repozitorija i razvojnog okruženja | MVP | 0   |
| S14-02 | Inicijalni .NET 10 API projekat sa middleware-om | MVP | 0   |
| S14-03 | Inicijalni SvelteKit frontend projekat | MVP | 0   |
| S14-04 | Inicijalna DB schema i migracije | MVP | 0   |
| S14-05 | Single-tenant konfiguracija za Sarajevo | MVP | 0   |
| S14-06 | i18n framework i lokalizacija | MVP | 0   |
| S14-07 | CI/CD pipeline | MVP | Kad tim procijeni |