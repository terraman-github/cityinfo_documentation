...
**Kontekst:** Korisnik je kreirao Event draft (S02-01) i sada dodaje lokaciju. Postoje dvije opcije: povezivanje sa vlastitim Place-om (samo ako je isti korisnik vlasnik oba listinga) ili ručna adresa sa koordinatama. Jedna od opcija je obavezna za objavu, ali ne za draft. Detalji → Ch.04, sekcija 4.2 (Lokacija listinga događaja).
