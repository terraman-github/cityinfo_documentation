...
- Kreiranje novih sektora — sektori su fiksni, dodaju se kroz seed data (E03a)
- Bulk import/export kategorija — eventualno Backlog
- Fulltext pretraga po aliasima — pokriveno u E04 (Pretraga)
- Public-facing API za čitanje kategorija/tagova — već isporučeno u E03a
...
- Zavisnost od E03a (entiteti moraju postojati) i E13 (Staff panel mora biti funkcionalan za pristup admin UI-ju).
...
| --- | --- | --- | --- |
| S03b-01 | CRUD kategorija kroz Staff panel | MVP | 5–6 |
| S03b-02 | CRUD tagova kroz Staff panel | MVP | 5–6 |
| S03b-03 | Spajanje tagova | MVP | 5–6 |
| S03b-04 | CRUD aliasa kategorija kroz Staff panel | MVP | 5–6 |