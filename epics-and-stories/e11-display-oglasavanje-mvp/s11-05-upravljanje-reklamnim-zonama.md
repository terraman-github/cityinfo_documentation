...
- [ ] Pri kreiranju oglasa (S11-01), Staff bira zonu iz dropdown-a sa dostupnim zonama
...
- UI: dropdown za izbor zone u formi za kreiranje/uređivanje oglasa (S11-01); opciono — lista zona u admin panelu za pregled
